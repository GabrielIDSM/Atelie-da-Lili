        ...
        return (
            <div className="Page">
                ...
                <div className="About_Full_Component">
                    ...
                    <p>A partir daí, fomos  adaptando o modelo até ficar melhorzinho rs. Então surge a nossa 1° cliente no Orkut!!! ( Magna Raimundo,  amiga da ateliê até hoje). Na mesma procura e sonho. - Por que não vender? Fiz um pra ela.. E começamos a produzir mascotes de vestir ( Mas do tipo cabeça de fantoche). </p>
                    ...
                    <p>Tenho muita gratidão por ter participado de tantos sonhos e projetos que mal consigo enumerar! Cantatas, musicais, evangelismo de rua, em tribos indígenas, comunidades ribeirinhas... E as apresentações que são feitas em alas infantis de hospitais por todo o Brasil? Ver o sorriso e alegria dessas crianças é extraordinário, algo Divino! - Sem palavras! Eu sou TODA gratidão por fazer parte desse plano maior de alguma forma. </p>
                </div>
            </div>
        );
    }
